...
// function processFolder(folderPath: string, targetObject: Record<string, string>): void {
...
// 		} else {
// 			targetObject[itemName] = path.relative(process.cwd(), itemPath).replace('public', '');
// 		}
// 	});
// }
